...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
   The variable 'count' is globally scoped in counter2 and function scoped in counter1
  2. Which of the two uses a closure? How can you tell?
   Counter2 uses a closure because has to look outside its function scope for count.
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     Counter1 would be preferable when you want the 'count' variable to only be used in this function. Counter2 would be better if you needed to use this variable elsewhere in other blocks of code.
*/
